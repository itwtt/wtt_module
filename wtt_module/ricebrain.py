...
@frappe.whitelist()
def updateValues(date,rate,no_of_bags,weight,amount,received_date,received_amount,id_name):
...
@frappe.whitelist()
def createNewRecord(date,rate,no_of_bags,weight,amount,received_date,received_amount):
