...
def get_data(item):
	...
	# Prepare dicts
	variant_dicts = [{"variant_name": d["name"],"last_purchase_rate":frappe.db.get_value("Purchase Order Item",
                                              filters={"docstatus": 1,"item_code": d["name"]},
                                              fieldname="base_rate",
                                              order_by="creation DESC",
                                              as_dict=False),"last_po":frappe.db.get_value("Purchase Order Item",
                                              filters={"docstatus": 1,"item_code": d["name"]},
                                              fieldname="parent",
                                              order_by="creation DESC",
                                              as_dict=False),"last_supplier":frappe.db.get_value("Purchase Order",
                                              filters={"name": frappe.db.get_value("Purchase Order Item",
                                              filters={"docstatus": 1,"item_code": d["name"]},
                                              fieldname="parent",
                                              order_by="creation DESC",
                                              as_dict=False)},
                                              fieldname="supplier",
                                              as_dict=False),"po_row":frappe.db.get_value("Purchase Order Item",
                                              filters={"docstatus": 1,"item_code": d["name"]},
                                              fieldname="idx",
                                              order_by="creation DESC",
                                              as_dict=False)} for d in variant_results]
