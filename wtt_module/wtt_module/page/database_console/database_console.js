...
MyPage = Class.extend({
	...
	make: function(){
		...
		$(frappe.render_template(frappe.wtt_module_page.body, this)).appendTo(this.page.main);
	  ...
	  document.head.appendChild(scrtag);
		...
		function makeQuery(formQuery){
			...
			frappe.call({
            method: "wtt_module.wtt_module.page.database_console.database_console.query_database", //dotted path to server method
