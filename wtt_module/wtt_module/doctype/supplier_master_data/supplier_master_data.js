...
frappe.ui.form.on('Supplier Master Data', {
	supplier_save:function(frm)
	{
		if(frm.doc.party_type=='Supplier'){
			...
			frappe.call({
						"method":"wtt_module.wtt_module.doctype.supplier_master_data.supplier_master_data.update_supplier",
						args:{
			...
			frappe.call({
						"method":"wtt_module.wtt_module.doctype.supplier_master_data.supplier_master_data.update_customer",
						args:{
	...
	address_save:function(frm)
	{
		...
		frappe.call({
					"method":"wtt_module.wtt_module.doctype.supplier_master_data.supplier_master_data.update_address",
					args:{
	...
	{
		frappe.call({
					"method":"wtt_module.wtt_module.doctype.supplier_master_data.supplier_master_data.update_contact",
					args:{
