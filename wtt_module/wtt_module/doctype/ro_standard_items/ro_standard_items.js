...
frappe.ui.form.on('RO Standard Items', {
	onload:function(frm)
	{
		if(frm.doc.ro_items)
		{
		...
		{
			// var ro=["MEMBRANE-1","MEMBRANE-2", "MEMBRANE-3","MEMBRANE-4", "MEMBRANE-5", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "FEED PUMP", "CIP PUMP-1", "CIP PUMP-2", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP SSB", "BOOSTER PUMP-1", "BOOSTER PUMP-1 SSB", "BOOSTER PUMP-2", "BOOSTER PUMP-2 SSB", "BOOSTER PUMP-3", "BOOSTER PUMP - 3 SSB", "HCL DOSING", "SMBS", "ANTISCALANT", "HCL DOSING", "Caustic Dosing", "LEVEL TRANSMITTER", "LEVEL FLOAT", "ELECTROMAGNETIC FLOWMETER - FEED", "ELECTROMAGNETIC FLOWMETER - REJECT", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 1", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 2", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 3", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 4", "ELECTROMAGNETIC FLOWMETER - CIP-1", "ELECTROMAGNETIC FLOWMETER - CIP-2", "PRESSURE TRANSMITTER - PRE-FILTER IN & OUT", "PRESSURE TRANSMITTER - STAGE 1 - IN & OUT", "PRESSURE TRANSMITTER - STAGE 2 - IN & OUT", "PRESSURE TRANSMITTER - STAGE 3 - IN & OUT", "PRESSURE TRANSMITTER - STAGE 4 - IN & OUT", "PRESSURE TRANSMITTER - CIP-1 - IN & OUT", "PRESSURE TRANSMITTER - CIP-2 - IN & OUT", "PRESSURE GAUGE - PRE-FILTER - IN & OUT", "PRESSURE GAUGE - STAGE 1 - IN & OUT", "PRESSURE GAUGE - STAGE 2 - IN & OUT", "PRESSURE GAUGE - STAGE 3 - IN & OUT", "PRESSURE GAUGE - STAGE 4 - IN & OUT", "PRESSURE GAUGE - CIP-1", "PRESSURE GAUGE - CIP-2", "pH SENSOR", "pH SENSOR - CIP-2", "RO PRE-FILTER", "CIP-1 PRE-FILTER", "CIP-2 PRE-FILTER", "CIP-1 TANK", "CIP-2 TANK","RO TANK-1","RO TANK-2","RO TANK-3", "CIP DOSING TANK-1", "CIP DOSING TANK-2","RO DOSING TANK-1", "RO DOSING TANK-2", "RO DOSING TANK-3", "RO SKID FRAME", "CIP SKID FRAME", "RO DOSING SKID FRAME", "CIP DOSING SKID FRAME"]
			// var ro_renamed=["RO MEMBRANE","RO MEMBRANE", "RO MEMBRANE","RO MEMBRANE", "RO MEMBRANE", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "SURFACE MOUNTED PUMP", "SURFACE MOUNTED PUMP", "SURFACE MOUNTED PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "DOSING PUMP", "DOSING PUMP", "DOSING PUMP", "DOSING PUMP", "DOSING PUMP", "LEVEL TRANSMITTER", "LEVEL FLOAT", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PH SENSOR", "PH SENSOR", "CARTRIDGE FILTER", "BAG FILTER", "BAG FILTER", "TANK", "TANK", "TANK", "TANK","TANK", "TANK", "TANK", "TANK", "TANK","TANK","FRAME", "FRAME", "FRAME", "FRAME"]
			// var ro = ["MEMBRANE-1", "MEMBRANE-2", "MEMBRANE-3", "MEMBRANE-4", "MEMBRANE-5", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "FEED PUMP", "CIP PUMP-1", "CIP PUMP-2", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP SSB", "BOOSTER PUMP-1", "BOOSTER PUMP-1 SSB", "BOOSTER PUMP-2", "BOOSTER PUMP-2 SSB", "BOOSTER PUMP-3", "BOOSTER PUMP - 3 SSB", "RO DOSING PUMP -1", "RO DOSING PUMP -2", "RO DOSING PUMP -3", "CIP DOSING PUMP-1", "CIP DOSING PUMP-2", "LEVEL TRANSMITTER", "LEVEL FLOAT", "ELECTROMAGNETIC FLOWMETER - FEED", "ELECTROMAGNETIC FLOWMETER - REJECT", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 1", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 2", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 3", "ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 4", "ELECTROMAGNETIC FLOWMETER - CIP-1", "ELECTROMAGNETIC FLOWMETER - CIP-2", "PRESSURE TRANSMITTER - PRE-FILTER IN & OUT", "PRESSURE TRANSMITTER - STAGE 1 - IN & OUT", "PRESSURE TRANSMITTER - STAGE 2 - IN & OUT", "PRESSURE TRANSMITTER - STAGE 3 - IN & OUT", "PRESSURE TRANSMITTER - STAGE 4 - IN & OUT", "PRESSURE TRANSMITTER - CIP-1 - IN & OUT", "PRESSURE TRANSMITTER - CIP-2 - IN & OUT", "PRESSURE GAUGE - PRE-FILTER - IN & OUT", "PRESSURE GAUGE - STAGE 1 - IN & OUT", "PRESSURE GAUGE - STAGE 2 - IN & OUT", "PRESSURE GAUGE - STAGE 3 - IN & OUT", "PRESSURE GAUGE - STAGE 4 - IN & OUT", "PRESSURE GAUGE - CIP-1", "PRESSURE GAUGE - CIP-2", "pH SENSOR","CONDUCTIVITY SENSOR", "pH SENSOR - CIP-2", "RO PRE-FILTER", "CIP-1 PRE-FILTER", "CIP-2 PRE-FILTER", "RO DOSING TANK-1", "RO DOSING TANK-2", "RO DOSING TANK-3", "CIP DOSING TANK-1", "CIP DOSING TANK-2", "CIP-1 TANK", "CIP-2 TANK", "RO SKID FRAME", "RO DOSING PUMP-1 FRAME", "RO DOSING PUMP-2 FRAME", "RO DOSING PUMP-3 FRAME", "CIP DOSING PUMP-1 FRAME", "CIP DOSING PUMP-2 FRAME", "RO DOSING TANK-1 FRAME", "RO DOSING TANK-2 FRAME", "RO DOSING TANK-3 FRAME", "CIP DOSING TANK-1 FRAME", "CIP DOSING TANK-2 FRAME", "CIP-1 TANK FRAME", "CIP-2 TANK FRAME"]
			// var ro_renamed = ["RO MEMBRANE", "RO MEMBRANE", "RO MEMBRANE", "RO MEMBRANE", "RO MEMBRANE", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "PRESSURE VESSEL", "SURFACE MOUNTED PUMP", "SURFACE MOUNTED PUMP", "SURFACE MOUNTED PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "HIGH PRESSURE PUMP", "DOSING PUMP", "DOSING PUMP", "DOSING PUMP", "DOSING PUMP", "DOSING PUMP", "LEVEL TRANSMITTER", "LEVEL FLOAT", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "ELECTROMAGNETIC FLOWMETER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE TRANSMITTER", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PRESSURE GAUGE", "PH SENSOR","CONDUCTIVITY SENSOR", "PH SENSOR", "CARTRIDGE FILTER", "BAG FILTER", "BAG FILTER", "TANK", "TANK", "TANK", "TANK", "TANK", "TANK", "TANK", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME", "FRAME"]
			var ro = ['MEMBRANE-1', 'MEMBRANE-2', 'MEMBRANE-3', 'MEMBRANE-4', 'MEMBRANE-5', 'PRESSURE VESSEL', 'PRESSURE VESSEL', 'PRESSURE VESSEL', 'PRESSURE VESSEL', 'FEED PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP SSB', 'BOOSTER PUMP-1', 'BOOSTER PUMP-1 SSB', 'BOOSTER PUMP-2', 'BOOSTER PUMP-2 SSB', 'BOOSTER PUMP-3', 'BOOSTER PUMP - 3 SSB', 'RO DOSING PUMP -1', 'RO DOSING PUMP -2', 'RO DOSING PUMP -3', 'LEVEL TRANSMITTER', 'LEVEL FLOAT', 'ELECTROMAGNETIC FLOWMETER - FEED', 'ELECTROMAGNETIC FLOWMETER - REJECT', 'ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 1', 'ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 2', 'ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 3', 'ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 4', 'PRESSURE TRANSMITTER - PRE-FILTER IN & OUT', 'PRESSURE TRANSMITTER - STAGE 1 - IN & OUT', 'PRESSURE TRANSMITTER - STAGE 2 - IN & OUT', 'PRESSURE TRANSMITTER - STAGE 3 - IN & OUT', 'PRESSURE TRANSMITTER - STAGE 4 - IN & OUT', 'PRESSURE GAUGE - PRE-FILTER - IN & OUT', 'PRESSURE GAUGE - STAGE 1 - IN & OUT', 'PRESSURE GAUGE - STAGE 2 - IN & OUT', 'PRESSURE GAUGE - STAGE 3 - IN & OUT', 'PRESSURE GAUGE - STAGE 4 - IN & OUT', 'pH SENSOR', 'CONDUCTIVITY SENSOR', 'RO PRE-FILTER', 'RO DOSING TANK-1', 'RO DOSING TANK-2', 'RO DOSING TANK-3', 'RO SKID FRAME', 'RO DOSING PUMP-1 FRAME', 'RO DOSING PUMP-2 FRAME', 'RO DOSING PUMP-3 FRAME', 'RO DOSING TANK-1 FRAME', 'RO DOSING TANK-2 FRAME', 'RO DOSING TANK-3 FRAME']
			var ro_renamed = ['RO MEMBRANE', 'RO MEMBRANE', 'RO MEMBRANE', 'RO MEMBRANE', 'RO MEMBRANE', 'PRESSURE VESSEL', 'PRESSURE VESSEL', 'PRESSURE VESSEL', 'PRESSURE VESSEL', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'HIGH PRESSURE PUMP', 'DOSING PUMP','DOSING PUMP','DOSING PUMP', 'LEVEL TRANSMITTER', 'LEVEL FLOAT']
			console.log(ro.length);
			console.log(ro_renamed.length);
			for(var i=0;i<ro.length;i++)
			{
			var child = frm.add_child("ro_items");
			frappe.model.set_value(child.doctype, child.name, "item_description", ro[i]);
			frappe.model.set_value(child.doctype, child.name, "renamed", ro_renamed[i]);
			frm.refresh_field("ro_items");
			}
		}
		if(frm.doc.ro_electrical_items)
		{

		}
		else
		{
			var ro_electrical=["FEED PUMP", "HIGH PRESSURE PUMP", "BOOSTER PUMP-1", "BOOSTER PUMP-2", "BOOSTER PUMP-3", "HCL DOSING", "SMBS", "ANTISCALANT",  "PANEL", "PLC" ]
			
			for(var i=0;i<ro_electrical.length;i++)
			{
			var child = frm.add_child("ro_electrical_items");
			frappe.model.set_value(child.doctype, child.name, "item_description", ro_electrical[i]);
			if(ro_electrical[i].includes("PRESSURE PUMP") || ro_electrical[i].includes("BOOSTER PUMP")){
				frappe.model.set_value(child.doctype, child.name, "vfd_type", "VFD FEEDER");
			}
			frm.refresh_field("ro_electrical_items");
			}
		}
	},
	get_data:function(frm)
	{
		$.each(frm.doc.ro_items || [], function(i, v) {
			...
			else if(v.item_description=='ELECTROMAGNETIC FLOWMETER - FEED' || v.item_description=='ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 1' || v.item_description=='ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 2' || v.item_description=='ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 3' || v.item_description=='ELECTROMAGNETIC FLOWMETER - PERMEATE - STAGE 4' || v.item_description=='ELECTROMAGNETIC FLOWMETER - CIP-1' || v.item_description=='ELECTROMAGNETIC FLOWMETER - CIP-2' || v.item_description=='PRESSURE TRANSMITTER - CIP-1 - IN & OUT' || v.item_description=='PRESSURE TRANSMITTER - CIP-2 - IN & OUT' || v.item_description=='RO PRE-FILTER' || v.item_description=='CIP-1 PRE-FILTER' || v.item_description=='CIP-2 PRE-FILTER' || v.item_description=='RO DOSING TANK-1' || v.item_description=='RO DOSING TANK-2' || v.item_description=='RO DOSING TANK-3'|| v.item_description=='CIP DOSING TANK-1' || v.item_description=='CIP DOSING TANK-2' || v.item_description=='CIP-1 TANK' || v.item_description=='CIP-2 TANK')
			{
				frappe.model.set_value(v.doctype, v.name, "w_qty",1)
				frm.refresh_fields("w_qty");
			}
			...
			else if(v.item_description=='BOOSTER PUMP-1 SSB' || v.item_description=='BOOSTER PUMP-2 SSB' || v.item_description=='BOOSTER PUMP-3 SSB')
			{
				frappe.model.set_value(v.doctype, v.name, "w_qty",1)
				frm.refresh_fields("w_qty");
			}
		});
		$.each(frm.doc.ro_electrical_items || [], function(i, v) {
			frappe.model.set_value(v.doctype, v.name, "w_qty",1)
			frm.refresh_fields("w_qty");
		})
	},
	qty_update:function(frm,cdt,cdn) {
		...
		var ele = ["FEED PUMP", "CIP PUMP-1", "CIP PUMP-2", "HIGH PRESSURE PUMP", "BOOSTER PUMP-1", "BOOSTER PUMP-2", "BOOSTER PUMP-3", "HCL DOSING", "SMBS", "ANTISCALANT", "HCL DOSING", "CAUSTIC DOSING", "PANEL", "PLC" ]
		$.each(frm.doc.ro_items || [], function(i, v) {
			if(ele.includes(v.item_description)){
				$.each(frm.doc.ro_electrical_items || [], function(i, vv) {
...
frappe.ui.form.on('RO Items', {
	flow:function(frm,cdt,cdn){
		...
		var ele=["FEED PUMP", "HIGH PRESSURE PUMP", "BOOSTER PUMP-1", "BOOSTER PUMP-2", "BOOSTER PUMP-3", "SMBS", "ANTISCALANT"]
