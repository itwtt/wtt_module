...
frappe.ui.form.on('Startup Sheet', {
	...
	anaerobic_settler_b:function(frm){
		var ar=["Anaerobic Screener", "Anaerobic Bar Screener","Anaerobic Lifting Pump","Anaerobic Neutralization", "Anaerobic System", "Anaerobic Cooling Tower","Anaerobic Settler",]
		append_selected_system(frm,ar)
	},
	dnt:function(frm){
	...
	validate:function(frm){
		...
		{
			frm.set_value("ovivo_feedd_qty",frm.doc.ovivo_no_of_trains);
			frm.refresh_field("ovivo_feedd_qty");
		}
		else
		{
			frm.set_value("ovivo_feedd_qty",0);
			frm.refresh_field("ovivo_feedd_qty");
		}
		...
		frm.set_value("ovivo_bc",((frm.doc.ovivo_backwash_flux*frm.doc.ovivo_area_required_for_filtration*frm.doc.ovivo_modules_train)/(frm.doc.ovivo_no_of_stacks_required*1000)));
		frm.refresh_field("ovivo_bc");

		frm.set_value("ovivo_cip",((frm.doc.ovivo_backwash_flux*frm.doc.ovivo_area_required_for_filtration*frm.doc.ovivo_modules_train)/(frm.doc.ovivo_no_of_stacks_required*1000)));
