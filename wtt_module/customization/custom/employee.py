...
class Employee(NestedSet):
	...
	def validate(self):
		if(self.experience=='Experienced'):# customized for experience calculation
			arr=[]
			arr2=[]
			...
			cc=len(arr2)-1
			bb = str(arr[cc])
			if(bb=="None" or aa=="None"):
				frappe.throw("Time intervals must be written in Experience Table")
			else:
